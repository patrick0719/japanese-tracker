// ─────────────────────────────────────────────────────────────────────────────
// translations.js  —  Per-user language system
// Place this file in /src/ next to App.js
//
// Language mapping:
//   admin          → English
//   viewer (PHGIC) → English
//   setouchi       → Japanese
//   wbc            → Japanese
//   gyoumusuishin  → Japanese
//   greenservices  → Japanese
// ─────────────────────────────────────────────────────────────────────────────
...
const ROLE_LANGUAGE_MAP = {
  ...
  const translations = {
    ...
    addTeacherLabel:    { en: 'Add Teacher',                      ja: '担当者を追加' },
    ...
    studentPlural:      { en: 'students',                         ja: '名' },
    ...
    // ── Categories ────────────────────────────────────────────────────────────────
    examCategoriesTitle: { en: 'Exam Categories',                 ja: '試験科目' },
    noExamCategories:   { en: 'No exam categories yet.',          ja: 'まだ試験科目がありません。' },
    addExamCategory:    { en: 'Add Exam Category',                ja: '試験科目を追加' },
    editCategoryModal:  { en: 'Edit Category',                    ja: '科目を編集' },
    ...
    // ── Evaluations ───────────────────────────────────────────────────────────────
    evaluationsTitle:   { en: 'Evaluations',                      ja: '評価一覧' },
    evaluations:        { en: 'Evaluations',                      ja: '評価一覧' },
    viewAllEvaluations: { en: 'View all evaluations →',           ja: '全評価を見る →' },
    noEvaluationsYet:   { en: 'No evaluations yet.',              ja: 'まだ評価がありません。' },
    addEvaluation:      { en: '+ Add Evaluation',                 ja: '＋ 評価を追加' },
    ...
    saveEvaluation:     { en: '💾 Save Evaluation',               ja: '💾 評価を保存' },
  
    // ── Exams ─────────────────────────────────────────────────────────────────────
    exams:              { en: 'Exams',                            ja: '試験一覧' },
    noExamsYet:         { en: 'No exams yet',                     ja: 'まだ試験がありません' },
    addExamHint:        { en: 'Add an exam to start tracking scores', ja: '試験を追加してスコアの記録を始めましょう' },
    addExam:            { en: '+ Add Exam',                       ja: '＋ 試験を追加' },
    ...
    // ── Progress Chart ────────────────────────────────────────────────────────────
    progressChart:      { en: 'Progress Chart',                   ja: '進捗グラフ' },
    ...
    back:               { en: '← Back',                          ja: '← 戻る' },
    storageTab:         { en: '🗄️ Storage',                       ja: '🗄️ ストレージ' },
    appInfoTab:         { en: '📊 App Info',                      ja: '📊 アプリ情報' },
    serverTab:          { en: '🖥️ Server',                        ja: '🖥️ サーバー' },
    manageTab:          { en: '🖼️ Manage',                        ja: '🖼️ 管理' },
    ...
    tapRefreshHint:     { en: 'Tap Refresh to view server stats.', ja: '更新ボタンをタップしてサーバー情報を表示してください。' },
  
  };
  
  // ─────────────────────────────────────────────────────────────────────────────
  // getLanguage() — reads current role from localStorage → returns 'en' or 'ja'
  // ─────────────────────────────────────────────────────────────────────────────
